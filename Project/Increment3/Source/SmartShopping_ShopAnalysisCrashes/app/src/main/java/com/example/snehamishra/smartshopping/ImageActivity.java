...
public class ImageActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private TextView uName, back, skip;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getApplicationContext(),"Clicking gallery button!!",Toast.LENGTH_SHORT).show();
                openGallery();
            }
        });
        ...
        camera.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(),"Clicking camera button!!",Toast.LENGTH_SHORT).show();
                openCamera();
            }
        });
        ...
        analyze.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getApplicationContext(),"Clicking analyze button!!",Toast.LENGTH_SHORT).show();
                callGoogleVision();
            }
        });
    ...
    //function to analyse the selected image
